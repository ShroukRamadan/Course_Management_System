...
public class Instructor extends User{
   ...
   FileManager filemanager = new FileManager();
    ...
    private String Instructordata(){
      return super.ID+"@"+super.fname+"@"+super.lname+"@"+super.Address+"@"+super.E_mail+"@"+super.Pnum+"@"+this.Coursename+"@"+this.work_time+"@"+super.Username+"@"+super.password+"@";
   }
   ...
   //so in this section i read and made some operations on this data
    ...
    public Instructor(String work_time, String Coursename, String fname, String lname, String E_mail, String Address, int ID, int Pnum, String password, String Username) {
